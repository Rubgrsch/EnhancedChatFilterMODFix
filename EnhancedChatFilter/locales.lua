...
--General
	...
	L["DebugWindow"] = "Debug"
	L["DebugMode"] = "Debug模式"
	L["DebugModeTooltips"] = "开启Debug模式，聊天信息会被记录并储存在WTF中，方便你查看哪些信息被过滤。|n这将占用一些内存。"
	L["ClearRecord"] = "清除聊天记录"
	L["ClearRecordTooltips"] = "清除记录的消息历史"
--BlackwordList
...
--General
	...
	L["DebugModeTooltips"] = "Enable debug mode. This will record chat msg into your WTF file so that you can identify those filtered msg. This will consume much memory."
	L["ClearRecord"] = "ClearRecord"
	L["ClearRecordTooltips"] = "Clear all recorded chat msgs."
--BlackwordList
